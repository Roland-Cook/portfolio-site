...
const Projects = () => {
  ...
  return (
    ...
    <div className={` gallery-image ${Visible ? "skillsShow" : "skillsHidden"} `}  ref={myRef}>
        ...
        <span className="worksDesc">Welcome to my portfolio – a collection of my creative work. Here, you'll find a variety of projects that showcase my skills and dedication. Feel free to explore and get in touch if you have questions or want to discuss potential collaborations.</span>
        </div>
